...
def _fit(data: Union[torch.Tensor, np.ndarray, zarr.Array],
    ...
    if mode == 'limits':
        ...
        # TODO: make this a param. Make the distribution wider so scale is smaller, so more datapts are between [-1, 1]. The wider the distr, the harder it is to learn in-liers, but easier to learn outliers.
        std2 = std * 1.5
