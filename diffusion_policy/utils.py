...
def load_global_config(cfg: DictConfig):
    ...
    # make the struct
    globals_struct = globals.GlobalConfig(
        CONFIG=cfg,
...
def load_config_to_global(config_key):
    global_config = globals.GLOBALS_DICT[config_key]

    globals.CONFIG = global_config.CONFIG
    globals.REPLAY_BUFFER_LOADER = global_config.REPLAY_BUFFER_LOADER
    globals.DATALOADERS = global_config.DATALOADERS
    globals.LOGGER = global_config.LOGGER
    globals.DEFAULT_BATCH_LOADER = global_config.DEFAULT_BATCH_LOADER
    globals.MODELS = global_config.MODELS
    globals.CHECKPOINTER = global_config.CHECKPOINTER
    globals.SESSION_TRAINER = global_config.SESSION_TRAINER