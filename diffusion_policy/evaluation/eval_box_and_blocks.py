...
NUM_CUSTOM_INFERENCE_STEPS = 100
...
CHECKPOINT_DIR = "/home/omnid/dexnex/libraries/diffusion_policy/outputs/2025-03-27/17-18-48/checkpoints"

# checkpoint name
CHECKPOINT_NAME = "epoch=0075-train_loss=0.016.ckpt"
...
class EvalDexNex(Node):
    ...
    def Run(self):
        ...
        # TEST - send 1 traj pt each half second
        # for i in range(NB_WAYPOINTS_TO_SKIP, NB_WAYPOINTS_TO_KEEP):
